...
// jsplumb连接参数
export const jsplumbConnectOptionsAdjust = {
  isSource: true,
  isTarget: true,
...
export const jsplumbSourceOptionsAdjust = {
...
export const jsplumbTargetOptionsAdjust = {
  filter: ".node-anchor",
  /*"span"表示标签，".className"表示类，"#id"表示元素id*/
  filterExclude: false,
  anchor: [
