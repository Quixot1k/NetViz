...
const BASICTYPE = ['output','input','sequence','conv2d','conv1d','bn2d','bn1d','linear','relu','sigmoid','tanh'
                    ,"maxpool2d","maxpool1d","adaptiveavgpool2d","op_view","op_add","op_cat","op_sampling"]
export {nodeTypeList,lossFcs,datasets,formConfig,BASICTYPE};